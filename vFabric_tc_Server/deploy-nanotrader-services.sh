...
export context=spring-nanotrader-services

export war_file=https://artifactory.slatchdev.local/artifactory/binrepo/springtrader/spring-nanotrader-services-1.0.1.war
wget --no-check-certificate $war_file
mv spring-nanotrader-services-1.0.1.war /tmp
export war_file=/tmp/spring-nanotrader-services-1.0.1.war
